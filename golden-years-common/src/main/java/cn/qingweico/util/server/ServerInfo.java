package cn.qingweico.util.server;

import cn.qingweico.util.Arith;
...
public class ServerInfo {
    ...
    private void setJvmInfo() {
        ...
        jvm.setStartTime(DateUtils.dateToString(DateUtils.getServerStartDate(), DateUtils.DATETIME_PATTERN));
