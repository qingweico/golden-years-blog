...
public final class SysConst {
    ...
    public final static String LINK_NAME = "linkName";
    ...
    public final static String SYMBOL_LEFT_CENTER_BRACKET = "[";
    public final static String SYMBOL_RIGHT_CENTER_BRACKET = "]";
