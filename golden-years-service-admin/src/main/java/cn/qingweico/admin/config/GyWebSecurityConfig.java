...
@EnableWebSecurity
@Slf4j
public class GyWebSecurityConfig extends WebSecurityConfigurerAdapter {
    /**
     * 自定义用户认证逻辑
     */
    @Resource
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        // 添加JWT filter(将 JwtAuthenticationTokenFilter 放在 UsernamePasswordAuthenticationFilter 过滤器之前)
