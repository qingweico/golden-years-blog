...
public class LoginController extends BaseController {
    ...
    public Result login(@RequestBody AdminLoginBO adminLoginBO) {
        ...
        boolean isPwdMatch = BCrypt.checkpw(adminLoginBO.getPassword(), sysUser.getPassword());
        if (isPwdMatch) {
    ...
    public Result logout() {
        ...
        redisTemplate.del(RedisConst.REDIS_ADMIN_INFO + SysConst.DELIMITER_COLON + adminId);
        redisTemplate.del(RedisConst.REDIS_ADMIN_TOKEN + SysConst.DELIMITER_COLON + adminId);
